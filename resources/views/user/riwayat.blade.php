            ...
            <table class="w-full border border-gray-200">
                <thead class="bg-blue-600 text-white">
                    <tr>
                        ...
                        <th class="px-4 py-3 border">Kota Awal</th>
                ...
                <tbody class="text-center">
                    ...
                    <tr class="hover:bg-gray-50" data-aos="fade-up">
                        ...
                        <td class="px-4 py-2 border">{{ $booking->jadwal->rute->kota_asal ?? '-' }}</td>
                        <td class="px-4 py-2 border">{{ $booking->jadwal->rute->kota_tujuan ?? '-' }}</td>
